const projects = [
  {
    ...
    print: [
      ...
      },
      {
        name: "Sucesso",
        description:
          "Página de sucesso, mostra as imagens dos produtos que a pessoa compro assim como o nome dela e a quantidade de produtos comprados.",
...

  {
    ...
    img: "/projects/SpaceComps/banner.png",
    title: "SpaceComps",
    type: "Website",
    ...
    print: [
      ...
      },
      {
        name: "Novo Chat",
        description:
          "Aba com uma lista contendo a opção de escolha de um novo chat.",
...

  {
    ...
    description:
      "Explore a plataforma de comércio eletrônico da PlayStation, dedicada à venda dos mais incríveis controles de videogame da marca. O website apresenta uma extensa lista de diferentes tipos e modelos de controles, tudo isso com uma estética dark mode envolvente e uma interface intuitiva que cativará você, repleta de animações sutis e atraentes.",
    tags: [
      {
        name: "Html",
